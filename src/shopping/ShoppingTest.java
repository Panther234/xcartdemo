...
public class ShoppingTest extends Utility {
    ...
    public void verifyThatUserShouldPlaceOrderSuccessfullyForAvengersFabrikationsPlush() throws InterruptedException {
        ...
        verifyText("Product has been added to your cart", getTextFromElement(By.xpath("//li[contains(.,'Product has been added to your cart')]")), "Error, Message not displayed");
        ...
        verifyText("Log in to your account", getTextFromElement(By.xpath("//h3[contains(text(),'Log in to your account')]")), "Error, Message not displayed as expected");
        ...
        Thread.sleep(2000);
        verifyText("Secure Checkout", getTextFromElement(By.xpath("//h1[contains(text(),'Secure Checkout')]")), "Error, Message not displayed as expected");
        ...
        sendKeysToElement(By.xpath("//input[@id='shippingaddress-zipcode']"), Keys.BACK_SPACE + "1");
